 ...
 * @LastEditTime: 2024-05-31 13:41:30
...
import { getListByRoleId ,getMenusByToken} from '@/api/account/menu'
...
export default defineStore({
  ...
  actions: {
    ...
    async getMeuns(){
        const {data:{menus}}=  await getMenusByToken() 

        this.addRoutes=[menus[1],menus[2]]
  
        
        return [menus[1],menus[2]]
    },
