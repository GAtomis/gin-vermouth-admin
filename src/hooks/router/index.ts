 ...
 * @LastEditTime: 2024-05-31 12:02:35
 ...
 */
export function resetRoute(list:any[]): void {
  console.log(list,'大大的');
 ...
 * @return {*}
 */
export function createRoute (menus:Menu[]){
...
export function addMenuSystem (menus:Menu[]){
